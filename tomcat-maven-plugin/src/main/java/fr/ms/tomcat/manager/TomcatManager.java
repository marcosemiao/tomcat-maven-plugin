...
public class TomcatManager {
    ...
    public TomcatManager(final URL url, final String username, final String password, final String charset) {
        this.url = url;
    ...
    public TomcatManager(final URL url, final String username, final String password) {
        this(url, username, password, "UTF-8");
    }

    public TomcatManager(final String url, final String username, final String password, final String charset)
            throws MalformedURLException {
        this(new URL(url), username, password, charset);
    }

    public TomcatManager(final String url, final String username, final String password) throws MalformedURLException {
        this(url, username, password, "UTF-8");
    }
    ...
    public void deploy(final String path, final String docBase) throws JDOMException, IOException,
